...
import { ArrowLeft, ArrowRight, Check, ChevronDown, ChevronRight, Clock3, Headphones, Heart, Leaf, Pencil, Search, Send, Share2, ShieldCheck, Star, Users, X, CalendarDays, Sparkles, SlidersHorizontal, Mountain, Ticket } from 'lucide-react';

const faqs = [
  'How do I book a trip?',
  'What is included in the trip?',
  'What is the cancellation policy?',
  'Do you provide local transport?',
  'Is the trip suitable for solo travellers?',
  'How will I get trip updates?',
];
